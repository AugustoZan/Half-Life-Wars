...
ENT.PrintName = "Half Life: Wars- Tutorial"
ENT.Author = "Alcachofas13"
ENT.Information = "This is the Tutorial Mode!"
...
local arena_length = 2000
local arena_width = 3000
...
local cam_offset = Vector( 0, 0, 800 )
local cam_angle = Angle( 0, 90, 0 )
local cam_points = {
...
util.AddNetworkString( "RagdollFightArenaSendMessage" )
	...
	function ENT:DrawSpectatorHUD()
		...
		if pl.RagdollFightArenaSpectator and pl.RagdollFightArenaSpectator:IsValid() and pl.RagdollFightArenaSpectator == self and IsValid( pl.RagdollFightArenaHUD ) then
			...
			cam.Start3D2D( self:GetPos() + cam_offset, cam_angle, 0.3)
